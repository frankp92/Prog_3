...
?>
        ...
        <div class="card-body">
            ...
            if(isset($_SESSION['logged_in']) == TRUE){
                if ($_SESSION['categoria'] == 'studente'){
                    include 'db/controllo_tirocinante.php';
                }
                elseif ($_SESSION['categoria'] == 'personale_tecnico'){
                    include 'db/controllo_lavoratore.php';
                }
            } 
            ?>
    ...
    ?>
        <a href="db/delete_project.php?IDprogetto=<?php echo $progetto['IDprogetto']; ?>" class="btn btn-primary">Cancella progetto</a>
    <?php
    }}
    ?>
        </div>
