<?php
    ...
    //controlla se stiamo cercando qualche progetto o se stiamo visualizzando tutti i progetti semplicemente
    if($file[0] == '/Smartlab2.0/search.php'){

        $cerca = $_GET['ricerca'];
        $array_progetto = array();

        //seleziona i progetti in base alla ricerca
    ...
    }else{//seleziona tutti i progetti
